                ...
                s = (function () {
                    ...
                    return (
                        ...
                        (s.prototype._setValue = function (a, b) {
                            ...
                            if (!a)
                                return (
                                    ...
                                    this._notifyEvent({ type: s.Event.CHANGE, date: !1, oldDate: c }),
                                    void this._update()
                                );
                            if (
                                ...
                                void 0 !== this.input && (this.input.val(d), this.input.trigger("input")),
                                    ...
                                    (this.unset = !1),
                                    this._update(),
                                    this._notifyEvent({ type: s.Event.CHANGE, date: this._dates[b].clone(), oldDate: c });
                            } else
                                this._options.keepInvalid
                                    ? this._notifyEvent({ type: s.Event.CHANGE, date: a, oldDate: c })
                                    : void 0 !== this.input && (this.input.val("" + (this.unset ? "" : this._dates[b].format(this.actualFormat))), this.input.trigger("input")),
                                    this._notifyEvent({ type: s.Event.ERROR, date: a, oldDate: c });
                        }),
                        ...
                        (s.prototype._viewUpdate = function (a) {
                            "y" === a && (a = "YYYY"), this._notifyEvent({ type: s.Event.UPDATE, change: a, viewDate: this._viewDate.clone() });
                        }),
                        (s.prototype._showMode = function (a) {
                            this.widget &&
                                (a && (this.currentViewMode = Math.max(q, Math.min(3, this.currentViewMode + a))),
                                this.widget
                                    .find(".datepicker > div")
                                    .hide()
